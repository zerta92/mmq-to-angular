    ...
    controller: [
        ...
        function AppointmentCardController(
            ...
            ctrl.rescheduleSelected = async function(message) {
                if (
                    message.appointment_Date == undefined ||
                    message.appointment_Time == undefined
                ) {
                ...
                const relevant_appointment_id =
                    message.related_Appointment || message.appointment_ID
